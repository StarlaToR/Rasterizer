...
# PROGRAM OBJS
OBJS=src/App.o src/Camera.o src/Framebuffer.o src/main.o src/maths.o src/Renderer.o src/Scene.o src/test.o src/Light.o src/Mesh.o src/Data_TheNobleCraftsman.o
